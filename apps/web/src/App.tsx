      ...
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-500 max-w-sm mx-auto">
            Transform your long, messy links into clean, powerful short URLs in seconds.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.07)] border border-gray-100 p-8 sm:p-10 transition-all hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.12)]">
          ...
          {shortUrl && (
            <div className="mt-8 pt-8 border-t border-gray-100 animate-in fade-in zoom-in-95 duration-500">
              <p className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-3 text-center">Successfully Shortened</p>
              ...
              {expiredAt && (
                <p className="mt-4 text-center text-sm text-gray-500">
                  Link expires on: <span className="font-semibold text-gray-700">{formatExpiry(expiredAt)}</span>
                </p>
              )}
        ...
        <p className="mt-12 text-center text-gray-400 text-sm font-medium">
          Built with <span className="text-blue-500">React</span> & <span className="text-cyan-500">Tailwind CSS</span>
        </p>
      </div>
    </div>
  );
